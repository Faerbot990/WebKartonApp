...
$jscomp.scope = {}, $jscomp.findInternal = function (t, a, e) {
    ...
    var a = function (a, e, n) {
        var s = {
            invalid: [], getCaret: function () {
                try {
                    var t = 0, e = a.get(0), n = document.selection, r = e.selectionStart;
                ...
                if (t !== e) {
                    ...
                    for (o = n; o < e && s.maskDigitPosMap[o]; o++) l++;
                    for (o = n - 1; 0 <= o && s.maskDigitPosMap[o]; o--) t++;
                    for (o = n - 1; 0 <= o; o--) s.maskDigitPosMap[o] && c++;
                    for (o = r - 1; 0 <= o; o--) s.maskDigitPosMapOld[o] && u++;
                ...
                if (-1 === t.inArray(n, o.byPassKeys)) {
                    n = s.getMasked();
                    var r = s.getCaret(), i = a.data("mask-previus-value") || "";
                ...
                var r, i = [], l = void 0 === a ? s.val() : a + "", c = 0, u = e.length, p = 0, f = l.length, d = 1,
                    v = "push", k = -1, m = 0;
                if (a = [], n.reverse) {
                    v = "unshift", d = -1;
                    var h = 0;
                ...
                } else h = u - 1, g = function () {
                    return c < u && p < f
                };
                for (; g();) {
                    var M = e.charAt(c), y = l.charAt(p), b = o.translation[M];
    ...
    t.fn.mask = function (e, s) {
        s = s || {};
        var r = this.selector, o = t.jMaskGlobals, i = o.watchInterval;
...
$(document).ready(function () {
    ...
    $('.menu span, .change_window').on('click', function () {
        ...
        $('.adm_content').removeClass('active');
        $('.adm_content[data-id=' + id + ']').addClass('active');
    });
        ...
        return $(
        	`<select name="subCategory">
      			${categories[selectedCategory].map(function (subcategory) {
            		return `<option value='${subcategory.value}'>${subcategory.label}</option>`;
        		})}
    		</select>`
		);
	}
    ...
    $('#add-prods input[name="filename"]').on('change', encodeImageFileAsURL(function(base64Img){
        $('#add-prods input[name="filename"]')
            .after("<input type='hidden' name='fileBase64' value='" + base64Img + "'>");
    }));

    $('#add-prods').on('submit', function (e) {
        e.preventDefault();
